...
if(APPLE)
set(ALL_SYRINGE_SUPPORTED_ARCH ${X86_64})
else()
set(ALL_SYRINGE_SUPPORTED_ARCH ${X86_64} ${ARM32} ${ARM64} ${MIPS32} ${MIPS64} powerpc64le)
endif()
...
if(APPLE)
  ...
  list_intersect(XRAY_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(SYRINGE_SUPPORTED_ARCH
    ALL_SYRINGE_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(SYRINGE_SUPPORTED_ARCH ${ALL_SYRINGE_SUPPORTED_ARCH})
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND SYRINGE_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Darwin|Linux|FreeBSD|NetBSD|OpenBSD")
  set(COMPILER_RT_HAS_SYRINGE TRUE)
else()
  set(COMPILER_RT_HAS_SYRINGE FALSE)
endif()
